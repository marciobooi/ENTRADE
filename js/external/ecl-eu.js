/* @ecl/preset-eu - 3.11.1 Built on 2023-11-07T08:42:44.364Z */
var ECL = (function (e, moment) {
        ...
        if (e)
          return "string" == typeof e
            ...
            : "Map" ===
                (i =
                  "Object" ===
                    (i = Object.prototype.toString.call(e).slice(8, -1)) &&
                  e.constructor
                    ? e.constructor.name
                    : i) || "Set" === i
            ? Array.from(e)
  ...
  var z = t(function (e, t) {
    ...
    e.exports = (function (moment) {
      var o = typeof moment === "function",
        ...
        p = function e(t, i) {
          if (!r(t, i))
            t.className = t.className === "" ? i : t.className + " " + i;
        },
        g = function e(t, i) {
          t.className = s(
        ...
        P = function e(t, i) {
          return [31, n(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][
            i
          ];
        },
        B = function e(t) {
          if (N(t)) t.setHours(0, 0, 0, 0);
        },
        R = function e(t, i) {
        ...
        F = function e(t) {
          ...
          if (t.isEmpty)
            if (t.showDaysInNextAndPreviousMonths) {
              ...
              if (!t.enableSelectionDaysInNextAndPreviousMonths)
                i.push("is-selection-disabled");
        ...
        e = function e(t) {
          ...
          if (n.keyboardInput) a(m, "keydown", s._onKeyChange);
          if (n.field) {
            if (n.container) n.container.appendChild(s.el);
            else if (n.bound) m.body.appendChild(s.el);
      ...
      return (
        (e.prototype = {
          config: function e(t) {
            ...
            i.disableDayFn =
              typeof i.disableDayFn === "function" ? i.disableDayFn : null;
            var s = parseInt(i.numberOfMonths, 10) || 1;
            i.numberOfMonths = s > 4 ? 4 : s;
            if (!N(i.minDate)) i.minDate = false;
            if (!N(i.maxDate)) i.maxDate = false;
            if (i.minDate && i.maxDate && i.maxDate < i.minDate)
              i.maxDate = i.minDate = false;
          ...
          adjustPosition: function e() {
            ...
            l = window.innerWidth || m.documentElement.clientWidth;
            a = window.innerHeight || m.documentElement.clientHeight;
            o =
              window.pageYOffset ||
              m.body.scrollTop ||
          ...
          render: function e(t, i, s) {
            ...
            for (var f = 0, y = 0; f < g; f++) {
              ...
              if (++y === 7) {
                if (n.showWeekNumber)
                  h.unshift(z(f - o, i, t, n.firstWeekOfYearMinDays));
          ...
          hide: function e() {
            var t = this._v;
            if (t !== false) {
              if (this._o.bound) i(m, "click", this._onClick);
          ...
          destroy: function e() {
            ...
            if (t.keyboardInput) i(m, "keydown", this._onKeyChange);
            if (t.field) {
  ...
  function h(e, t) {
    void 0 === t && (t = !0);
    var i =
      null == e || null == (i = e.getAttribute) ? void 0 : i.call(e, "inert");
  ...
  function W(e, t) {
    ...
    if (
      ((t = d.call(e, "details>summary:first-of-type") ? e.parentElement : e),
      d.call(t, "details:not([open]) *"))
    )
      return 1;
        ...
        (function (e) {
          ...
          if (i && i !== e)
            for (
              ...
              var l,
                n = !(
                  null == (l = s = null == (l = i = u(s)) ? void 0 : l.host) ||
  ...
  var i = [
    ...
    u =
      !l && Element.prototype.getRootNode
        ? function (e) {
            var t;
    ...
    O = function (e, t, i) {
      ...
      return h(e)
        ? []
        : ((s = Array.prototype.slice.apply(e.querySelectorAll(c))),
          t && d.call(e, c) && s.unshift(e),
          s.filter(i));
    },
    T = function e(t, i, s) {
        ...
        h(r, !1) ||
          ("SLOT" === r.tagName
            ...
            : (d.call(r, c) &&
              ...
              (o = !h(a, !1) && (!s.shadowRootFilter || s.shadowRootFilter(r))),
              a && o
            ...
            for (var t = e.parentElement; t; ) {
              if ("FIELDSET" === t.tagName && t.disabled) {
                for (var i = 0; i < t.children.length; i++) {
                  ...
                  if ("LEGEND" === s.tagName)
                    return (
                      !!d.call(t, "fieldset[disabled] *") || !s.contains(e)
                    );
                }
                return !0;
              }
  ...
  function g(e, t) {
    ...
    function a() {
      if (
        ((m.containerGroups = m.containers.map(function (e) {
          var s = (function (e, t) {
              e = (t = t || {}).getShadowRoot
        ...
        m.tabbableGroups.length <= 0 && !g("fallbackFocus"))
      )
        throw new Error(
          "Your focus-trap must have at least one container with at least one tabbable node in it at all times"
        );
      if (
        m.containerGroups.find(function (e) {
          return e.posTabIndexesFound;
        }) &&
        1 < m.containerGroups.length
      )
        throw new Error(
    ...
    function n() {
      if (m.active)
        $(d, k),
          (m.delayInitialFocusTimer = u.delayInitialFocus
            ? N(function () {
                b(v());
              })
            : b(v())),
          c.addEventListener("focusin", y, !0),
          c.addEventListener("mousedown", i, { capture: !0, passive: !1 }),
          c.addEventListener("touchstart", i, { capture: !0, passive: !1 }),
          c.addEventListener("click", C, { capture: !0, passive: !1 }),
          c.addEventListener("keydown", L, { capture: !0, passive: !1 });
    }
    function r() {
      if (m.active)
        c.removeEventListener("focusin", y, !0),
          c.removeEventListener("mousedown", i, !0),
          c.removeEventListener("touchstart", i, !0),
          c.removeEventListener("click", C, !0),
          c.removeEventListener("keydown", L, !0);
    }
    function h() {
      w &&
        (w.disconnect(), m.active) &&
        !m.paused &&
        m.containers.map(function (e) {
    ...
    var c = (null == t ? void 0 : t.document) || document,
      ...
      v = function () {
        ...
        if (
          (t =
            void 0 !== t && A(t, u.tabbableOptions)
              ? t
              : 0 <= p(c.activeElement)
              ? c.activeElement
              : ((e = m.tabbableGroups[0]) && e.firstTabbableNode) ||
                g("fallbackFocus"))
        )
          return t;
        throw new Error(
      ...
      s = function e(t) {
        t = t.activeElement;
        if (t)
          return t.shadowRoot && null !== t.shadowRoot.activeElement
            ? e(t.shadowRoot)
            : t;
      },
      b = function e(t) {
      ...
      f = function (e) {
        var t,
          ...
          l = (a(), null);
        return (
          0 < m.tabbableGroups.length
            ? ((t = 0 <= (i = p(s, n)) ? m.containerGroups[i] : void 0),
              i < 0
                ? (l = e
                    ? m.tabbableGroups[m.tabbableGroups.length - 1]
                        .lastTabbableNode
                    : m.tabbableGroups[0].firstTabbableNode)
                : e
                ? 0 <=
                  (e =
                    (e = D(m.tabbableGroups, function (e) {
                      e = e.firstTabbableNode;
                      return s === e;
                    })) < 0 &&
                    (t.container === s ||
                      (A(s, u.tabbableOptions) &&
                        !x(s, u.tabbableOptions) &&
                        !t.nextTabbableNode(s, !1)))
                      ? i
                      : e)
                  ? ((e = 0 === e ? m.tabbableGroups.length - 1 : e - 1),
                    (e = m.tabbableGroups[e]),
                    (l =
                      0 <= S(s) ? e.lastTabbableNode : e.lastDomTabbableNode))
                  : R(n) || (l = t.nextTabbableNode(s, !1))
                : 0 <=
                  (e =
                    (e = D(m.tabbableGroups, function (e) {
                    ...
                    (t.container === s ||
                      ...
                      ? i
                      : e)
                ? ((i = e === m.tabbableGroups.length - 1 ? 0 : e + 1),
                  (e = m.tabbableGroups[i]),
                  (l =
                    0 <= S(s) ? e.firstTabbableNode : e.firstDomTabbableNode))
                : R(n) || (l = t.nextTabbableNode(s)))
            : (l = g("fallbackFocus")),
          l
        );
      },
      i = function (e) {
        ...
        0 <= p(t, e) ||
          (P(u.clickOutsideDeactivates, e)
            ? k.deactivate({ returnFocus: u.returnFocusOnDeactivate })
      ...
      y = function (e) {
        ...
        s || i instanceof Document
          ? s && (m.mostRecentlyFocusedNode = i)
          : (e.stopImmediatePropagation(),
            (s = !0),
            m.mostRecentlyFocusedNode
              ? 0 < S(m.mostRecentlyFocusedNode)
                ? ((i = p(m.mostRecentlyFocusedNode)),
                  0 < (e = m.containerGroups[i].tabbableNodes).length &&
                    0 <=
                      (i = e.findIndex(function (e) {
                        return e === m.mostRecentlyFocusedNode;
                      })) &&
                    (u.isKeyForward(m.recentNavEvent)
                      ? i + 1 < e.length && ((t = e[i + 1]), (s = !1))
                      : 0 <= i - 1 && ((t = e[i - 1]), (s = !1))))
                : m.containerGroups.some(function (e) {
            ...
            s &&
              (t = f({
                ...
                isBackward: u.isKeyBackward(m.recentNavEvent),
              })),
            b(t || m.mostRecentlyFocusedNode || v())),
          (m.recentNavEvent = void 0);
      },
      E = function (e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
          t = ((m.recentNavEvent = e), f({ event: e, isBackward: t }));
      ...
      L = function (e) {
        ...
        !1 === P(u.escapeDeactivates, e)
          ? (u.isKeyForward(e) || u.isKeyBackward(e)) &&
            E(e, u.isKeyBackward(e))
          : (e.preventDefault(), k.deactivate());
      },
      C = function (e) {
        var t = B(e);
        0 <= p(t, e) ||
          P(u.clickOutsideDeactivates, e) ||
          P(u.allowOutsideClick, e) ||
        ...
        activate: function (e) {
          ...
          return (
            m.active ||
              ...
              (s = l(e, "checkCanFocusTrap")) || a(),
              (m.active = !0),
              (m.paused = !1),
              (m.nodeFocusedBeforeActivation = c.activeElement),
              null != t && t(),
              (e = function () {
                s && a(), n(), h(), null != i && i();
              }),
              s ? s(m.containers.concat()).then(e, e) : e()),
            this
          );
        },
        deactivate: function (e) {
          ...
          return (
            m.active &&
              ...
              clearTimeout(m.delayInitialFocusTimer),
              (m.delayInitialFocusTimer = void 0),
              r(),
              (m.active = !1),
              (m.paused = !1),
              h(),
              ...
              (e = function () {
                N(function () {
                  n && b(o(m.nodeFocusedBeforeActivation)), null != i && i();
                });
              }),
              n && s ? s(o(m.nodeFocusedBeforeActivation)).then(e, e) : e()),
            this
          );
        },
        pause: function (e) {
  ...
  var v = t(function (e) {
      ...
      function t() {
        var e, t, i;
        function s() {
          d.pageXOffset != g.left
            ? ((g.top = d.pageYOffset),
              (g.left = d.pageXOffset),
              f.refreshAll())
            : d.pageYOffset != g.top &&
              ((g.top = d.pageYOffset),
              (g.left = d.pageXOffset),
          ...
          },
          {
            ...
            value: function () {
              if (this._active && !this._removed) {
                var e =
                  g.top <= this._limits.start
                    ? "start"
                    : g.top >= this._limits.end
                    ? "end"
                    : "middle";
      ...
      Element.prototype.closest ||
        ...
        (e.exports =
          ...
          (b = function e(t, i) {
            i.nested &&
              (t = t.parentNode.closest("li")) &&
              (t.classList.add(i.nestedClass), e(t, i));
          }),
          function (e, t) {
            function i(e) {
        ...
        ((i = [
          ...
          function (e, B, t) {
            ...
            var l = t(2),
              ...
              D =
                (D = d()) &&
                (/iPad|iPhone|iPod/.test(D.platform) ||
                  ("MacIntel" === D.platform && 1 < D.maxTouchPoints)) &&
                !window.MSStream,
              ie = n(),
              se = u("iPhone"),
              ne = u("iPod"),
          ...
          function (e, t, i) {
            var n, d, s, u, l, a, o, r, h, c, m, p, g, v, b, f, y, E, L, C, w;
            function k(e, t) {
              var i, s;
              return (
  ...
  class f {
    ...
    constructor(e, t) {
      ...
      (this.element = e),
        ...
        (this.closeButtonLabel = g),
        (this.closeLabelAttribute = u),
        (this.clearAllLabelAttribute = m),
        (this.input = null),
        (this.search = null),
    ...
    init() {
      ...
      (this.textDefault =
        ...
        this.inputContainer.appendChild(f.createSelectIcon()),
        ...
        this.textSelectAll &&
          ((e = Array.from(this.select.options).filter(
            (e) => !e.disabled
          ).length),
          (this.selectAll = f.createCheckbox(
            {
        ...
        this.select.options &&
          ...
          (this.checkboxes = Array.from(this.select.options).map((e) => {
            ...
            return (
              ...
              e.selected &&
                (this.updateSelectionsCount(1), this.dropDownToolbar) &&
        ...
        case "ArrowDown":
          ...
          this.selectAll.querySelector("input").disabled
            ? (t = Array.from(
              ...
              ).filter((e) => "none" !== e.style.display))[0] &&
              t[0].querySelector("input").focus()
  ...
  class y {
    ...
    static createSortIcon(e) {
      var t = document.createElement("span"),
        t =
          ((t.innerHTML =
            '<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 24 24" enable-background="new 0 0 24 24"><path d="M7.4 13 11 9.4c.5-.5 1.4-.5 2 0l3.6 3.6c.9.9.2 2.4-1 2.4H8.4c-1.3 0-1.9-1.5-1-2.4"/></svg>'),
          t.children[0]);
      return (
        ...
        t.setAttribute("class", "ecl-table__icon ecl-icon ecl-icon--m " + e),
        t
      );
    }
    init() {
      if (!ECL) throw new TypeError("Called init but ECL is not present");
      (ECL.components = ECL.components || new Map()),
        (this.sortHeadings = a(this.sortSelector, this.element)),
        this.sortHeadings &&
          this.sortHeadings.forEach((t) => {
            var e = document.createElement("button");
            e.classList.add("ecl-table__arrow"),
              e.appendChild(y.createSortIcon("ecl-table__icon-up")),
              e.appendChild(y.createSortIcon("ecl-table__icon-down")),
              t.appendChild(e),
  ...
  return (
    (e.Accordion = class E {
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.toggles = a(this.toggleSelector, this.element)),
          (this.label = o(this.labelSelector, this.element)),
          this.attachClickListener &&
            this.toggles &&
            this.toggles.forEach((e) => {
              e.addEventListener(
                "click",
                this.handleClickOnToggle.bind(this, e)
              );
            }),
          this.element.setAttribute("data-ecl-auto-initialized", "true"),
          ECL.components.set(this.element, this);
      ...
      handleClickOnToggle(e) {
        var t,
          i,
          s,
          n = o("#" + e.getAttribute("aria-controls"), this.element);
        if (n)
          return (
            (t =
              !0 === this.forceClose ||
            ...
            (n.hidden = t),
            (n = (n = o(this.iconSelector, e)) && o("use", n)) &&
              ((s = n.getAttribute("xlink:href")),
              (i = ""),
              (i = t ? s.replace("minus", "plus") : s.replace("plus", "minus")),
              n.setAttribute("xlink:href", i)),
            (s = o(".ecl-accordion__toggle-label", e)) &&
              (s.textContent = t
    ...
    (e.Breadcrumb = class L {
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.ellipsisButton = o(this.ellipsisButtonSelector, this.element)),
          this.attachClickListener &&
            this.ellipsisButton &&
          ...
          (this.itemsElements = a(this.segmentSelector, this.element)),
          (this.staticElements = a(this.staticItemsSelector, this.element)),
          (this.expandableElements = a(
      ...
      computeVisibilityMap() {
        var t, i, s, n;
        return !this.expandableElements ||
          0 === this.expandableElements.length ||
          ((t = Math.floor(this.element.getBoundingClientRect().width)),
          this.itemsElements
            .map((e) => e.getBoundingClientRect().width)
            .reduce((e, t) => e + t) <= t)
          ? { expanded: !0 }
          : ((i =
              o(this.ellipsisSelector, this.element).getBoundingClientRect()
                .width +
                  ...
                  isItemVisible: [...this.expandableElements]
                    ...
                    .map(
                      (e) =>
                        !!n &&
                        ((e =
                          (s += e.getBoundingClientRect().width) + i <= t) ||
                          (n = !1),
                        e)
                    )
                    .reverse(),
    ...
    (e.BreadcrumbCore = class C {
      static autoInit(e, t) {
        return (
          (t =
            void 0 === (t = (void 0 === t ? {} : t).BREADCRUMB_CORE) ? {} : t),
          (t = new C(e, t)).init(),
    ...
    (e.BreadcrumbHarmonised = class ee {
      static autoInit(e, t) {
        return (
          (t =
            void 0 === (t = (void 0 === t ? {} : t).BREADCRUMB_HARMONISED)
              ? {}
              : t),
          (t = new ee(e, t)).init(),
    ...
    (e.BreadcrumbStandardised = class te {
      static autoInit(e, t) {
        return (
          (t =
            void 0 === (t = (void 0 === t ? {} : t).BREADCRUMB_STANDARDISED)
              ? {}
              : t),
          (t = new te(e, t)).init(),
    ...
    (e.Carousel = class ie {
      ...
      init() {
        ...
        if (ECL)
          return (
            (ECL.components = ECL.components || new Map()),
            (this.btnPlay = o(this.playSelector, this.element)),
            (this.btnPause = o(this.pauseSelector, this.element)),
            (this.btnPrev = o(this.prevSelector, this.element)),
            (this.btnNext = o(this.nextSelector, this.element)),
            (this.slidesContainer = o(this.slidesClass, this.element)),
            (this.container = o(this.containerClass, this.element)),
            (this.navigation = o(".ecl-carousel__navigation", this.element)),
            (this.navigationItems = a(this.navigationItemsClass, this.element)),
            (this.pagination = o(this.paginationClass, this.element)),
            (this.controls = o(this.controlsClass, this.element)),
            (this.currentSlide = o(this.currentSlideClass, this.element)),
            (this.direction = getComputedStyle(this.element).direction),
            (this.slides = a(this.slideClass, this.element)),
              ...
              : ((e = this.slides[0]),
                ...
                this.attachClickListener &&
                  ...
                  this.btnNext.addEventListener(
                    "click",
                    this.shiftSlide.bind(this, "next", !0)
                  ),
                this.attachClickListener &&
                  this.btnPrev &&
                  this.btnPrev.addEventListener(
                    "click",
                    this.shiftSlide.bind(this, "prev", !0)
                  ),
                this.slidesContainer &&
    ...
    (e.CategoryFilter = class se {
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.items = a(this.itemSelector, this.element)),
          this.attachClickListener &&
            this.items &&
    ...
    (e.ContentBlock = class ne {
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          ...
          this.picture &&
            ((this.title = o(this.titleSelector, this.element)),
            (this.linkEl = !!this.title && o("a", this.title)),
            this.linkEl &&
              ((this.picture.style.cursor = "pointer"),
              (e = o("img", this.picture)) &&
                this.withTitleAttr &&
    ...
    (e.Datepicker = class le {
      ...
      constructor(e, t) {
        var i =
          ...
          t =
            void 0 === (t = t.enableSelectionDaysInNextAndPreviousMonths) || t;
        if (!e || e.nodeType !== Node.ELEMENT_NODE)
          throw new TypeError(
            "DOM element should be given to initialize this widget."
          );
        ...
        if (ECL)
          return (
            ...
            (this.picker = new z({
              ...
              position:
                "rtl" === this.direction ? "bottom right" : "bottom left",
              showDaysInNextAndPreviousMonths:
    ...
    (e.DescriptionList = class ae {
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          ...
          (this.lists = a(this.listsSelector, this.element)),
          this.lists[0] &&
            0 < this.visibleItems &&
            this.moreItemLabel &&
            (this.lists.forEach((e) => {
              ...
              e.children &&
                ...
                (t.href = "#"),
                (t.innerHTML = this.moreItemLabel),
                e.appendChild(t),
                this.showHide(a(".ecl-description-list__definition-item", e)),
                this.attachClickListener) &&
                t.addEventListener("click", this.handleClickOnMore);
            }),
            this.element.setAttribute("data-ecl-auto-initialized", "true"),
            ECL.components.set(this.element, this));
      }
      ...
      destroy() {
        ...
        this.attachClickListener &&
          0 < this.visibleItems &&
          (e = a(".ecl-description-list__see_more"))[0] &&
          e.forEach((e) => {
    ...
    (e.Expandable = class oe {
      ...
      init() {
        ...
        if (
          ((ECL.components = ECL.components || new Map()),
          (this.toggle = o(this.toggleSelector, this.element)),
    ...
    (e.FileDownload = class re {
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.translationToggle = o(
            this.translationToggleSelector,
            this.element
          )),
          (this.translationContainer = o(
    ...
    (e.FileUpload = class he {
      ...
      constructor(e, t) {
        var i =
            void 0 === (i = (t = void 0 === t ? {} : t).groupSelector)
              ...
              : i,
          s =
            void 0 === (s = t.buttonSelector)
              ? "[data-ecl-file-upload-button]"
              : s,
          n =
            void 0 === (n = t.listSelector) ? "[data-ecl-file-upload-list]" : n,
          l =
            void 0 === (l = t.labelChoose)
              ? "data-ecl-file-upload-label-choose"
              : l,
          a =
            void 0 === (a = t.labelReplace)
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          ...
          (this.fileUploadButton = o(
            this.buttonSelector,
            this.fileUploadGroup
          )),
          (this.fileUploadList = o(this.listSelector, this.fileUploadGroup)),
      ...
      handleChange(e) {
        ...
        "files" in e.target
          ...
          : this.fileUploadButton.hasAttribute(this.labelChoose) &&
            (this.fileUploadButton.innerHTML =
              this.fileUploadButton.getAttribute(this.labelChoose));
      }
    }),
    (e.Gallery = class ce {
      static autoInit(e, t) {
      ...
      constructor(e, t) {
        var i =
          ...
          p =
            void 0 === (p = t.overlayHeaderSelector)
              ...
              : p,
          g =
            void 0 === (g = t.overlayFooterSelector)
              ? "[data-ecl-gallery-overlay-footer]"
              : g,
          v =
            void 0 === (v = t.overlayMediaSelector)
          ...
          y =
            void 0 === (y = t.overlayDownloadSelector)
              ...
              : y,
          E =
            void 0 === (E = t.overlayShareSelector)
              ? "[data-ecl-gallery-overlay-share]"
              : E,
          L =
            void 0 === (L = t.overlayDescriptionSelector)
              ? "[data-ecl-gallery-overlay-description]"
              : L,
          C =
            void 0 === (C = t.overlayMetaSelector)
              ? "[data-ecl-gallery-overlay-meta]"
              : C,
          w =
            void 0 === (w = t.overlayPreviousSelector)
              ? "[data-ecl-gallery-overlay-previous]"
              : w,
          k =
            void 0 === (k = t.overlayNextSelector)
        ...
        (this.element = e),
          ...
          (this.noOverlaySelector = l),
          (this.overlayHeaderSelector = p),
          (this.overlayFooterSelector = g),
          (this.overlayMediaSelector = v),
          (this.overlayCounterCurrentSelector = b),
          (this.overlayCounterMaxSelector = f),
          (this.overlayDownloadSelector = y),
          (this.overlayShareSelector = E),
          (this.overlayDescriptionSelector = L),
          (this.overlayMetaSelector = C),
          (this.overlayPreviousSelector = w),
          (this.overlayNextSelector = k),
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          ...
          (this.galleryItems = a(this.galleryItemSelector, this.element)),
          (this.closeButton = o(this.closeButtonSelector, this.element)),
          (this.noOverlay = this.element.hasAttribute(this.noOverlaySelector)),
          this.expandable &&
            ((this.viewAll = o(this.viewAllSelector, this.element)),
            (this.viewAllLabel =
            ...
            (this.viewAllLabelExpanded =
              ...
              this.viewAllLabel)),
          (this.count = o(this.countSelector, this.element)),
          this.attachClickListener &&
            this.viewAll &&
          ...
          this.noOverlay
            ...
            : ((this.overlay = o(this.overlaySelector, this.element)),
              (this.overlayHeader = o(
                this.overlayHeaderSelector,
                this.overlay
              )),
              (this.overlayFooter = o(
                this.overlayFooterSelector,
                this.overlay
              )),
              (this.overlayMedia = o(this.overlayMediaSelector, this.overlay)),
              (this.overlayCounterCurrent = o(
                this.overlayCounterCurrentSelector,
                this.overlay
              )),
              (this.overlayCounterMax = o(
                this.overlayCounterMaxSelector,
                this.overlay
              )),
              (this.overlayDownload = o(
                this.overlayDownloadSelector,
                this.overlay
              )),
              (this.overlayShare = o(this.overlayShareSelector, this.overlay)),
              (this.overlayDescription = o(
                this.overlayDescriptionSelector,
                this.overlay
              )),
              (this.overlayMeta = o(this.overlayMetaSelector, this.overlay)),
              (this.overlayPrevious = o(
                this.overlayPreviousSelector,
                this.overlay
              )),
              (this.overlayNext = o(this.overlayNextSelector, this.overlay)),
      ...
      iframeResize(t) {
        var i;
        (t = !t && this.overlay ? o("iframe", this.overlay) : t) &&
          ((i = window.innerWidth),
          setTimeout(() => {
            var e =
      ...
      updateOverlay(e) {
        var t = (this.selectedItem = e).getAttribute(
        ...
        null != t
          ...
          : ((n = o("img", e)),
            (i = o("picture", e))
              ? (n.classList.remove("ecl-gallery__image"),
                (s = i.cloneNode(!0)))
        ...
        null !=
        (i = this.selectedItem.getAttribute("data-ecl-gallery-item-share"))
        ...
        var n = o(this.metaSelector, e),
          i =
            ((this.overlayMeta.innerHTML = n.innerHTML),
            o(this.descriptionSelector, e));
      ...
      handleClickOnCloseButton() {
        ...
        e && e.remove(),
          (e = o("video", this.overlayMedia)) && e.pause(),
    ...
    (e.MediaContainer = class ue {
      ...
      init() {
        ...
        e &&
          ...
          ((this.iframe = o(this.iframeSelector, this.element)), this.iframe) &&
          this.useAutomaticRatio &&
          this.calculateRatio(),
          this.element.setAttribute("data-ecl-auto-initialized", "true"),
          ECL.components.set(this.element, this);
      }
    ...
    (e.Menu = class me {
      ...
      constructor(e, t) {
        var i =
          ...
          l =
            void 0 === (l = t.overlaySelector) ? "[data-ecl-menu-overlay]" : l,
          ...
          c =
            void 0 === (c = t.buttonPreviousSelector)
              ? "[data-ecl-menu-items-previous]"
              : c,
          d =
            void 0 === (d = t.buttonNextSelector)
              ? "[data-ecl-menu-items-next]"
              : d,
          u = void 0 === (u = t.caretSelector) ? "[data-ecl-menu-caret]" : u,
          m = void 0 === (m = t.megaSelector) ? "[data-ecl-menu-mega]" : m,
          p =
            void 0 === (p = t.subItemSelector) ? "[data-ecl-menu-subitem]" : p,
        ...
        (this.element = e),
          ...
          (this.itemSelector = r),
          (this.linkSelector = h),
          (this.buttonPreviousSelector = c),
          (this.buttonNextSelector = d),
          (this.caretSelector = u),
          (this.megaSelector = m),
          (this.subItemSelector = p),
          (this.maxLines = g),
          (this.maxLinesAttribute = v),
          (this.attachClickListener = b),
          (this.attachHoverListener = f),
          (this.attachFocusListener = y),
          (this.attachKeyListener = E),
          (this.attachResizeListener = t),
          (this.direction = "ltr"),
          (this.open = null),
          (this.close = null),
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          (this.direction = getComputedStyle(this.element).direction),
          (this.open = o(this.openSelector, this.element)),
          (this.close = o(this.closeSelector, this.element)),
          (this.back = o(this.backSelector, this.element)),
          (this.overlay = o(this.overlaySelector, this.element)),
          (this.inner = o(this.innerSelector, this.element)),
          (this.itemsList = o(this.listSelector, this.element)),
          (this.btnPrevious = o(this.buttonPreviousSelector, this.element)),
          (this.btnNext = o(this.buttonNextSelector, this.element)),
          (this.items = a(this.itemSelector, this.element)),
          (this.subItems = a(this.subItemSelector, this.element)),
          (this.links = a(this.linkSelector, this.element)),
          (this.carets = a(this.caretSelector, this.element));
      ...
      checkMenuOverflow() {
        this.itemsList || (this.itemsList = o(".ecl-menu__list", this.element)),
          this.itemsList &&
            this.inner &&
            this.btnNext &&
            this.btnPrevious &&
      ...
      checkMegaMenu(e) {
        ...
        if (t && this.inner) {
          if ((i = a(this.subItemSelector, t)).length < 5)
      ...
      handleKeyboard(e) {
        ...
        if ("Escape" === e.key || "Esc" === e.key)
          document.activeElement === t && t.blur(),
            "false" === s &&
              ((l = o(".ecl-menu__button-caret", n)) && l.focus(),
          ...
          if (i.contains("ecl-menu__button-caret") && "false" === s) {
            ...
            if ("ArrowDown" === e.key)
              if ((l = o(".ecl-menu__sublink:first-of-type", n)))
                return void l.focus();
          }
          if (
          ...
          i.contains("ecl-menu__sublink") &&
            ...
            (n = o(".ecl-menu__sublink", l))
              ? n.focus()
              : "ArrowUp" === e.key &&
                ((s = t.parentElement.previousSibling)
                  ? (i = o(".ecl-menu__sublink", s)) && i.focus()
                  : (l = o(
                      this.itemSelector +
                        '[aria-expanded="true"] ' +
                        this.caretSelector,
      ...
      handleHoverOnItem(e) {
        ...
        (this.hasOverflow && !t.hasAttribute("data-ecl-menu-item-visible")) ||
          (this.items.forEach((e) => {
            e === t
              ? e.setAttribute("aria-expanded", "true")
              : (e.setAttribute("aria-expanded", "false"),
                (e = o(".ecl-menu__button-caret", e)) && e.blur());
          }),
          this.checkMegaMenu(t));
      }
      ...
      handleFocusOut(e) {
        ...
        "true" !== this.element.getAttribute("aria-expanded") ||
          ...
          ((t = o(".ecl-menu__button-caret", e.parentElement)) && e !== t) ||
          this.close.focus();
      }
    }),
    (e.Message = class pe {
    ...
    (e.Modal = class ge {
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          ...
          (this.close = a(this.closeSelector, this.element)),
          (this.scroll = o(this.scrollSelector, this.element)),
          (this.focusTrap = g(this.element)),
          (this.isDialogSupported = !0),
          window.HTMLDialogElement || (this.isDialogSupported = !1),
          this.toggle &&
            this.attachClickListener &&
    ...
    (e.NewsTicker = class ve {
      ...
      init() {
        ...
        if (ECL)
          return (
            ...
            (this.slidesContainer = o(this.slidesClass, this.element)),
            (this.container = o(this.containerClass, this.element)),
            (this.content = o(this.contentClass, this.element)),
            (this.controls = o(this.controlsClass, this.element)),
            (this.slides = a(this.slideClass, this.element)),
            (this.total = this.slides.length),
      ...
      checkIndex() {
        0 === this.index && ((this.index = this.total), this.moveSlides(!1)),
          ...
          (o(this.currentSlideClass, this.element).textContent = this.index),
          this.slides &&
            this.slides.forEach((e, t) => {
              var i = o(".ecl-link", e);
              this.index === t
    ...
    (e.Range = class fe {
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.rangeInput = o(this.rangeInputSelector, this.element)),
          (this.currentValue = o(this.currentValueSelector, this.element)),
          this.rangeInput &&
            this.currentValue &&
    ...
    (e.SiteHeader = class ye {
        ...
        var i =
          ...
          a =
            void 0 === (a = t.languageListNonEuSelector)
              ...
              : a,
          o =
            void 0 === (o = t.closeOverlaySelector)
              ? "[data-ecl-language-list-close]"
              : o,
          r =
            void 0 === (r = t.searchToggleSelector)
              ? "[data-ecl-search-toggle]"
              : r,
          h =
            void 0 === (h = t.searchFormSelector)
              ? "[data-ecl-search-form]"
              : h,
          c =
            void 0 === (c = t.loginToggleSelector)
              ? "[data-ecl-login-toggle]"
              : c,
          d = void 0 === (d = t.loginBoxSelector) ? "[data-ecl-login-box]" : d,
          u = void 0 === (u = t.attachClickListener) || u,
          m = void 0 === (m = t.attachKeyListener) || m,
          t = void 0 === (t = t.attachResizeListener) || t;
        if (!e || e.nodeType !== Node.ELEMENT_NODE)
          throw new TypeError(
            "DOM element should be given to initialize this widget."
      ...
      init() {
        ...
        (ECL.components = ECL.components || new Map()),
          ...
          this.attachResizeListener &&
            window.addEventListener("resize", this.handleResize),
          (this.container = o(this.containerSelector)),
          (this.languageLink = o(this.languageLinkSelector)),
          (this.languageListOverlay = o(this.languageListOverlaySelector)),
          (this.languageListEu = o(this.languageListEuSelector)),
          (this.languageListNonEu = o(this.languageListNonEuSelector)),
          (this.close = o(this.closeOverlaySelector)),
          ...
          (this.searchToggle = o(this.searchToggleSelector)),
          (this.searchForm = o(this.searchFormSelector)),
          this.attachClickListener &&
            this.searchToggle &&
            this.searchToggle.addEventListener("click", this.toggleSearch),
          (this.loginToggle = o(this.loginToggleSelector)),
          (this.loginBox = o(this.loginBoxSelector)),
          this.attachClickListener &&
            this.loginToggle &&
      ...
      updateOverlay() {
        var e = 1,
          ...
          i =
            (this.languageListEu &&
              ((i = a(".ecl-site-header__language-item", this.languageListEu)),
    ...
    (e.SiteHeaderCore = class Ee {
        ...
        var i =
          ...
          s =
            void 0 === (s = t.languageListOverlaySelector)
              ...
              : s,
          n =
            void 0 === (n = t.closeOverlaySelector)
              ? "[data-ecl-language-list-close]"
              : n,
          l =
            void 0 === (l = t.searchToggleSelector)
              ? "[data-ecl-search-toggle]"
              : l,
          a =
            void 0 === (a = t.searchFormSelector)
              ? "[data-ecl-search-form]"
              : a,
          o =
            void 0 === (o = t.loginToggleSelector)
              ? "[data-ecl-login-toggle]"
              : o,
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.languageSelector = o(this.languageLinkSelector)),
          (this.languageListOverlay = o(this.languageListOverlaySelector)),
          (this.close = o(this.closeOverlaySelector)),
          (this.focusTrap = g(this.languageListOverlay, {
            onDeactivate: this.closeOverlay,
      ...
      destroy() {
        this.languageSelector &&
          this.languageSelector.removeEventListener(
            "click",
            this.toggleOverlay
          ),
          this.focusTrap && this.focusTrap.deactivate(),
    ...
    (e.Tabs = class we {
      ...
      constructor(e, t) {
        var i =
            void 0 === (i = (t = void 0 === t ? {} : t).listSelector)
              ? ".ecl-tabs__list"
              : i,
          s =
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.list = o(this.listSelector, this.element)),
          (this.listItems = a(this.listItemsSelector, this.element)),
          (this.moreItem = o(this.moreItemSelector, this.element)),
          (this.moreButton = o(this.moreButtonSelector, this.element)),
          (this.moreLabel = o(this.moreLabelSelector, this.element)),
      ...
      shiftTabs(e) {
        ...
        var e =
            0 === this.index
              ? 0
              : this.btnPrev.getBoundingClientRect().width + 13,
          t = 0;
        (this.direction = getComputedStyle(this.element).direction),
          (t =
            "rtl" === this.direction
        ...
        (this.tabsKey = []),
          this.listItems.forEach((e, t, i) => {
            ...
            "false" !== e.getAttribute("aria-hidden") &&
              (e = this.dropdownItems[t]),
              (s = o(".ecl-tabs__link", e)).addEventListener(
                "keydown",
    ...
    (e.Timeline = class ke {
      ...
      init() {
        if (!ECL) throw new TypeError("Called init but ECL is not present");
        (ECL.components = ECL.components || new Map()),
          (this.button = o(this.buttonSelector, this.element)),
          (this.label = o(this.labelSelector, this.element)),
          this.attachClickListener &&
            this.button &&
