    ...
    const browser = `<div class="ecl-row subNavBar">
            <div class="">
              <button id="menu" class="btnGroup" type="button" aria-label="${
                ...
                <span data-i18n="${languageNameSpace.labels["MAINMENU"]}">${languageNameSpace.labels["MENU"]}</span>
              </button>
            </div>

           
              <div class="text-group">
                <h2 id="title" class="title">${languageNameSpace.labels["header-title-label"]}</h2>                      
              </div>
          ...
          <div class="ecl-col-4">
            <div id="chartBtns"  aria-label="Options graph toolbox" class="ecl-navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 50vw;">
              ...
              <div id="switchBtn">  
                ...
                <div class="nav-item dropdown px-1" id="infoBtnChart" aria-haspopup="menu">
                ...
                <div class="nav-item button px-1" id="embebedChart" aria-haspopup="menu">
                ...
                <div class="nav-item dropdown px-1" id="social-media" aria-haspopup="menu">
                <button class="ecl-button ecl-button--primary round-btn" type="button" aria-label="${
                ...
                <div class="ecl-dropdown-menu ecl-dropdown-menu-end" style="padding: 12px;" role="menu" aria-labelledby="Share chart">     			
...
<div class="close-button-container">
    ...
    if (mobileFlag) {
      ...
      this.toolsButton.addEventListener("click", () => {
        this.chartOptionsMenu.classList.contains("toggleMenu")
          ? ""
      ...
      this.menuButton.addEventListener("click", () => {
        this.chartToolsMenu.classList.contains("d-none")
          ? ""
          : this.chartToolsMenu.classList.toggle("d-none");
        this.toggleChartOptionsMenu();
      });
      ...
      function toggleSwitch(switchElement) {
        switchElement.addEventListener("click", () => {
          ...
          switchElement.setAttribute(
            "aria-checked",
            switchElement.value === "top5" ? "true" : "false",
          );
  ...
  initializeDropdowns() {
    ...
    const dropdownButtons = this.subNavbar.querySelectorAll(
      '[data-ecl-toggle="dropdown"]',
    );
    ...
    dropdownButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        if (menu && menu.classList.contains("ecl-dropdown-menu")) {
          ...
          const otherMenus = this.subNavbar.querySelectorAll(
            ".ecl-dropdown-menu.show",
          );
